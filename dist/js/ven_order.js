Vue.createApp({
    data() {
        return {
            ...
            sel_ven_month :[],
            sel_u_role    :['ผู้พิพากษา','ผอ./แทน','จนท.1','จนท.2','จนท.3','จนท.4','จนท.5'],
            sel_u_role_t  :{'':'00','ผู้พิพากษา':'00', 'ผอ./แทน':'01','จนท.1':'02','จนท.2':'03','จนท.3':'04','จนท.4':'05','จนท.5':'06'},
            sel_DN        :['กลางวัน','กลางคืน'],
            sel_DN_t      :{'':'08:30','กลางวัน':'08:30','กลางคืน':'16:30'},
            sel_ven_name  :['ฟื้นฟู/ตรวจสอบการจับ/หมายจับ-ค้น','ฟื้นฟู/ตรวจสอบการจับ','หมายจับ-ค้น/รักษาการณ์','หมายจับ-ค้น'],
