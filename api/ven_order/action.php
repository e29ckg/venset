...
try{
    ...
    // }    
    // if($action == 'update'){
    //     // $ven_com_detail[0]->ven_time
    //     $ven_time = $_DN[$ven_com_detail[0]->DN].':'.$vt[$ven_com_detail[0]->u_role]; 
    //                         $sql = "UPDATE ven_com SET 
    //                             ven_com_num     =:ven_com_num, 
    //                             ven_com_date    =:ven_com_date,
    //                             ven_month       =:ven_month, 
    ...
    //             $query->bindParam(':ven_time',$ven_com_detail[0]->ven_time, PDO::PARAM_STR);
    //             $query->bindParam(':DN',$ven_com_detail[0]->DN, PDO::PARAM_STR);
    //             $query->bindParam(':u_role',$ven_com_detail[0]->u_role, PDO::PARAM_STR);
    //             $query->bindParam(':ven_com_name',$ven_com_detail[0]->ven_com_name, PDO::PARAM_STR);
    //             $query->bindParam(':price',$ven_com_detail[0]->price, PDO::PARAM_STR);
    //             $query->bindParam(':id',$ven_com->id, PDO::PARAM_INT);
    //             $query->execute();
    ...
    //     http_response_code(200);
    //     echo json_encode(array('status' => true, 'message' => 'ok', 'responseJSON' => $ven_com_detail[0]));
    //     exit;                
    // }  
